...
dev_var.add('firewall_policy.0.move_index', var_type='Composite')
dev_var.add('firewall_policy.0.status', var_type='Boolean')
dev_var.add('firewall_policy.0.srcintf', var_type='OBMFRef')
dev_var.add('firewall_policy.0.srcaddr', var_type='OBMFRef')
dev_var.add('firewall_policy.0.dstintf', var_type='OBMFRef')
dev_var.add('firewall_policy.0.dstaddr_selector', var_type='String')
dev_var.add('firewall_policy.0.dstaddr', var_type='Composite')
dev_var.add('firewall_policy.0.dst_nat', var_type='Composite')
dev_var.add('firewall_policy.0.service', var_type='OBMFRef')
dev_var.add('firewall_policy.0.action', var_type='String')
dev_var.add('firewall_policy.0.nat', var_type='Composite')
dev_var.add('firewall_policy.0.naptSelector', var_type='Composite')
dev_var.add('firewall_policy.0.napt_object', var_type='Composite')
