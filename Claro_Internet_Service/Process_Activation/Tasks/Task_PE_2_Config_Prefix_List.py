...
dev_var = Variables()
dev_var.add('pe_2_prefix_list.0.list_name', var_type='String')
dev_var.add('pe_2_prefix_list.0.action', var_type='String')
dev_var.add('pe_2_prefix_list.0.address', var_type='String')
...
for device in context['pe_2_prefix_list']:
