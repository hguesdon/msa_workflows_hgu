...
dev_var = Variables()
dev_var.add('pe_2_bgp.0.bgp_as', var_type='String')
dev_var.add('pe_2_bgp.0.neighbor', var_type='String')
dev_var.add('pe_2_bgp.0.remote_as', var_type='String')
dev_var.add('pe_2_bgp.0.route_map', var_type='String')
...
for device in context['pe_2_bgp']:
