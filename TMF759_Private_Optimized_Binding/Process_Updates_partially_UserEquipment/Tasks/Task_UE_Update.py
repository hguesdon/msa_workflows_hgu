...
dev_var.add('ue_update_data', var_type='String')
...
payload=context['ue_update_data']
...
context['ue_update_response']= response.json()


try:
	json_string = json.dumps(context['ue_update_response'])
	json_object = json.loads(json_string)
	if "failed" in context['ue_update_response']:
		MSA_API.task_error(context['ue_update_response'],context, True)
	MSA_API.task_success(context['ue_update_response'],context, True)
