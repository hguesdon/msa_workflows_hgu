...
dev_var.add('device_assign_from_bpm', var_type='String')
dev_var.add('template_assign_from_bpm', var_type='String')
...
object_parameters['Assign_SDWAN_Template'] [object_id]['device_name']=context['device_assign_from_bpm']
object_parameters['Assign_SDWAN_Template'] [object_id]['template_name']=context['template_assign_from_bpm']
