...
p = subprocess.Popen(["ssh  root@"+ip+" export KUBECONFIG=/root/sylva-core/management-cluster-kubeconfig "], shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE).communicate()
output=""
