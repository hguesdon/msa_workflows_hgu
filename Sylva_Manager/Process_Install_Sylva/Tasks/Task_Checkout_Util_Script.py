...
p = subprocess.Popen(["ssh  root@"+ip+" \" git clone https://github.com/amitraj83/util.git && chmod 777 /root/util/set-cluster-ip.sh \" "], shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE).communicate()
output=""
