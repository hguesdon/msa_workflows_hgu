...
p = subprocess.Popen(["ssh  root@"+ip+" dpkg --configure -a "], shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE).communicate()
p = subprocess.Popen(["ssh  root@"+ip+" apt update "], shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE).communicate()

output = ""
p = subprocess.Popen(["ssh  root@"+ip+" docker info "], shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE).communicate()
